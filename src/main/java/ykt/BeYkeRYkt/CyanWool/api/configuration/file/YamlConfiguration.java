package ykt.BeYkeRYkt.CyanWool.api.configuration.file;
...
import ykt.BeYkeRYkt.CyanWool.api.configuration.Configuration;
import ykt.BeYkeRYkt.CyanWool.api.configuration.ConfigurationSection;
import ykt.BeYkeRYkt.CyanWool.api.configuration.InvalidConfigurationException;
...
public class YamlConfiguration extends FileConfiguration {
    ...
    public String saveConfigSectionWithComments(ConfigurationSection section, boolean depth) {
        ...
        for (Iterator<Map.Entry<String, Object>> i = section.getValues(false).entrySet().iterator(); i.hasNext();) {
            ...
            if (entry.getValue() instanceof ConfigurationSection) {
                ...
                else builder.append("'" + entry.getKey() + "'");
    ...
    public static YamlConfiguration loadConfiguration(File file) {
        ...
        try {
            ...
            CyanWool.getLogger().error("Cannot load " + file, ex);
    ...
    public static YamlConfiguration loadConfiguration(InputStream stream) {
        ...
        try {
            ...
            CyanWool.getLogger().error("Cannot load configuration from stream", ex);
        } catch (InvalidConfigurationException ex) {
            CyanWool.getLogger().error("Cannot load configuration from stream", ex);
        }
