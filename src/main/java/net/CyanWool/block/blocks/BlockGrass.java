...
public class BlockGrass extends BlockType {
    ...
    public BlockGrass() {
        super(2, 0);
        SoundInfo dig = new SoundInfo(MagicValues.value(String.class, GenericSound.DIG_GRASS), 1.0F, 1.0F);
        SoundInfo step = new SoundInfo(MagicValues.value(String.class, GenericSound.GRASS_STEP), 1.0F, 1.0F);
